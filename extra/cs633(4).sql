...
# Database: cs633
# Generation Time: 2015-11-25 21:45:22 +0000
# ************************************************************
...
INSERT INTO `office` (`office_id`, `office_name`, `city`, `state`, `address1`, `address2`, `zip`, `contact_name`, `contact_phone`, `contact_email`, `notes`, `status`)
VALUES
...
INSERT INTO `skill` (`skill_id`, `skill_name`, `added_employee_id`, `skill_status`)
VALUES
	(1,'Java',0,1),
	(2,'PHP',0,1),
	(3,'CSS',0,1),
...
INSERT INTO `user` (`employee_id`, `office_id`, `first_name`, `last_name`, `email_address`, `password`, `office_phone`, `user_type`, `job_title`, `hire_date`, `notes`, `status`, `hr_contact`, `employee_contact`, `last_updated`)
VALUES
	...
	(3435332,1,'Tracy','Smith','tracy.smith@company.com','','617-415-2222 x432',1,'HR Partner','1972-04-05','My notes.',1,1,0,'2015-11-25 15:59:33'),
	(4542132,2,'Alex','Elentukh','alex.elentukh@company.com','','',2,'Technology Specialist','2005-06-15',NULL,1,1,1,'2015-11-20 19:38:36'),
	(4546476,2,'Gary','Johnson','gary.johnson@company.com','',NULL,1,NULL,NULL,NULL,1,1,1,NULL),
...
UPDATE user SET password=AES_ENCRYPT('cs633','4034ewewfejiooi3');
